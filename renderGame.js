    ...
    function Game(parent){
        ...
        function beforeBegin(){
            ...
            if(parent.innerHTML==''){
                ...
                parent.innerHTML='<h2 style="text-align: center;line-height: 300px;font-size: 16px;cursor: pointer">请点击开始</h2>'
                parent.style.background='#pink';
            }
        ...
        //当点击的元素的相邻元素flag==0时，交换元素，并render
        function move(num){
